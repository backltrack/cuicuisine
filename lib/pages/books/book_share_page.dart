...
class _BookSharePageState extends State<BookSharePage> {
  ...
  void initState() {
    ...
    bookSharingUnderstood =
        DatabaseMgr().localMgr.loadBookSharingAgreement() ?? false;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final shareText = "cuicuisine://book/${book.id}";

    return Scaffold(
      appBar: AppBar(title: Text(S.of(context).book_settings_share)),
      body: _book != null
          ? Column(
              children: [
                // share book
                    ...
                    if (!bookSharingUnderstood) {
                      await showInfoDialog(
                        ...
                        description: Column(
                          ...
                          children: [
                            Text(
                              S.of(context).info_share_book_description1,
                              textAlign: TextAlign.center,
                            ),
                            Text(
                              S.of(context).info_share_book_description2,
                              textAlign: TextAlign.center,
                            ),
                            Text(
                              _book!
                                          .access[DatabaseMgr().localMgr
                                              .getUser()!
                                              .id]!
                                          .index <
                                  ...
                                  : S
                                        .of(context)
                                        .info_share_book_description_owner,
                              textAlign: TextAlign.center,
                            ),
                          ],
                        ),
                        ...
                        if (value != null && value) {
                          DatabaseMgr().localMgr.saveBookSharingAgreement(
                            value,
                          );
                        }
                      });
                ...
                Container(
                  ...
                  child: Center(
                    child: TextButton(
                      ...
                      onPressed: () =>
                          Clipboard.setData(ClipboardData(text: _book!.id)),
                      child: Text(_book!.id),
                    ),
                  ),
                ),
