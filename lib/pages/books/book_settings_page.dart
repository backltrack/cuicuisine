...
class _BookSettingsPageState extends State<BookSettingsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(S.of(context).book_settings_page_title)),
      body: isReady
              ...
              child: Column(
                children: [
                  ...
                  Center(
                    child: CircleAvatar(
                      radius: 96 / 2 + 36,
                      backgroundColor: ThemeMgr.getTheme(
                        context,
                      )!.colorScheme.surface,
                      child: Image.asset(
                  ...
                  // Rename book
                  if (_book!
                          .access[DatabaseMgr().localMgr.getUser()!.id]!
                          .index ==
                      AccessLevel.own.index)
                    ListTile(
                      title: Text(S.of(context).book_settings_rename),
                      onTap: () {
                        if (!DatabaseMgr().isCompatible) {
                          ToastNotifier().showWarning(
                            S.of(context).outdated_version_login_blocked,
                          );
                          return;
                        }
                        Navigator.of(context)
                            ...
                            .then((mustUpdate) async {
                              if (mustUpdate != null &&
                                  mustUpdate == "update") {
                                var tmp = DatabaseMgr().localMgr.getBook(
                                  _book!.id,
                                );
                                if (tmp != null) {
                                  setState(() {
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        ...
                        showAlertDialog(
                          ...
                          description: Text(
                            '${S.of(context).popup_quit_description}${_book!.name}?',
                          ),
                        ).then((value) async {
                          if (value != null && value) {
                            bool isConnected = await DatabaseMgr().remoteMgr
                                .testConnexion();
                            if (isConnected) {
                              bool result = await DatabaseMgr().remoteMgr
                                  .revokeUserFromBook(_book!.id);
                              if (result) {
                            ...
                            return Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  if (_book!
                                          .access[_book!.users[index]]!
                                          .index ==
                                      AccessLevel
                                          .own
                                          .index) // this book user is owner
                                    Container(
                                  ...
                                  if (_book!
                                      ...
                                      AccessLevel
                                          .own
                                          .index) // this book user is not owner
                                    Row(
                                      children: [
                                        _book!
                                                    .access[DatabaseMgr()
                                                ...
                                                onPressed: () async {
                                                  if (!DatabaseMgr()
                                                    ...
                                                    ToastNotifier().showWarning(
                                                      S
                                                          .of(context)
                                                          .outdated_version_login_blocked,
                                                    );
                                                    return;
                                                  }
                                                  showAlertDialog(
                                                    ...
                                                    action: S
                                                        ...
                                                        .popup_remove_user_title,
                                                    description: Text(
                                                      '${S.of(context).popup_remove_user_description}$name?',
                                                    ),
                                                  ).then((value) async {
                                                    if (value != null &&
                                                        value) {
